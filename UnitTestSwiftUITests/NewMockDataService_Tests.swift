...
final class NewMockDataService_Tests: XCTestCase {
    ...
    func test_NewMockDataService_downloadWithEscaping_doesValuesCorrectly(){
        //Given
    ...
    func test_NewMockDataService_downloadWithCombine_doesValuesCorrectly(){
        //Given
        let dataService = NewMockDataService(items: nil)
        //When
        var items: [String] = []
